...
namespace Euro.Core.Automation.Page.Base
{
    ...
    /// </summary>
    public abstract class BasePageSection : IAssertableComponent, ISearchContext
    {
        /// <summary>
        ...
        /// </summary>
        public IWebElement WebElementImplementation { get; set; }
        ...
        /// <inheritdoc />
        public IWebElement FindElement(By by) => WebElementImplementation.FindElement(@by);

        /// <inheritdoc />
        public ReadOnlyCollection<IWebElement> FindElements(By by) => WebElementImplementation.FindElements(by);
