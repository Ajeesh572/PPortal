...
namespace Euro.Core.Automation.Component
{
    ...
    /// </summary>
    public abstract partial class BaseComponent : IAssertableComponent
    {
        /// <summary>
        ...
        {
            Driver = WebDriverManager.Instance.GetWebDriver;
            Wait = WebDriverManager.Instance.GetWebDriverWait;
