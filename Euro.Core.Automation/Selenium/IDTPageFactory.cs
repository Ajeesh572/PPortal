// <copyright file="IDTPageFactory.cs" company="Eurofins">
...
namespace Euro.Core.Automation.Selenium
{
    ...
    public class IDTPageFactory
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IDTPageFactory"/> class.
        /// Private constructor prevents a default instance from being created.
        /// </summary>
        private IDTPageFactory()
        {
        }
        ...
        /// <para>-or-</para>
        /// if a field or property decorated with the <see cref="IDTFindByAttribute"/> is not of type
        /// <see cref="IWebElement"/> or IList{IWebElement}.
        /// </exception>
        public static T InitElements<T>(IWebDriver driver)
        {
            return InitElements<T>(new IDTDefaultElementLocator(driver));
        }
        ...
        /// <exception cref="ArgumentException">
        /// thrown if a field or property decorated with the <see cref="IDTFindByAttribute"/> is not of type
        /// <see cref="IWebElement"/> or IList{IWebElement}.
        /// </exception>
        public static void InitElements(ISearchContext driver, object page)
        {
            InitElements(page, new IDTDefaultElementLocator(driver));
        }
        ...
        {
            InitElements(page, new IDTDefaultElementLocator(driver), decorator);
        }
        ...
        {
            InitElements(page, locator, new IDTDefaultPageObjectMemberDecorator());
        }
