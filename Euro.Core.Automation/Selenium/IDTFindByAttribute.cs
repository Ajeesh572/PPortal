// <copyright file="IDTFindByAttribute.cs" company="Eurofins">
...
namespace Euro.Core.Automation.Selenium
{
    ...
    /// in conjunction with the <see cref="IDTPageFactory"/>, it allows you to quickly create Page Objects.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <see cref="ArgumentException"/> when <see cref="IDTPageFactory.InitElements(ISearchContext, object)"/> is called.
    /// </para>
    /// <para>
    /// <code>
    ...
    /// </para>
    /// </remarks>
    public class IDTFindByAttribute : Attribute, IComparable
    {
        ...
        /// <summary>
        /// Gets or sets the value of Resx file (i.e. HostLocator, the actual name excluding .resx extension)
        /// </summary>
        public string File { get; set; }

        /// <summary>
        /// Gets or sets the key value to lookup in Resx file
        /// </summary>
        ...
        /// <summary>
        /// Determines if two <see cref="IDTFindByAttribute"/> instances are equal.
        /// </summary>
        /// <param name="one">One instance to compare.</param>
        /// <param name="two">The other instance to compare.</param>
        /// <returns><see langword="true"/> if the two instances are equal; otherwise, <see langword="false"/>.</returns>
        public static bool operator ==(IDTFindByAttribute one, IDTFindByAttribute two)
        {
        ...
        /// <summary>
        /// Determines if two <see cref="IDTFindByAttribute"/> instances are unequal.
        /// </summary>s
        /// <param name="one">One instance to compare.</param>
        /// <param name="two">The other instance to compare.</param>
        ...
        /// <summary>
        /// Determines if one <see cref="IDTFindByAttribute"/> instance is greater than another.
        /// </summary>
        /// <param name="one">One instance to compare.</param>
        /// <param name="two">The other instance to compare.</param>
        ...
        /// <summary>
        /// Determines if one <see cref="IDTFindByAttribute"/> instance is less than another.
        /// </summary>
        /// <param name="one">One instance to compare.</param>
        /// <param name="two">The other instance to compare.</param>
        ...
        public int CompareTo(object obj)
        {
            ...
            IDTFindByAttribute other = obj as IDTFindByAttribute;
            if (other == null)
            {
